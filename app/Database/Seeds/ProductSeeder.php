...
class ProductSeeder extends Seeder
{
    ...
    {
        $data = [];
        $getProduct = fn ($name, $category = 'Kue Basah') => ['name' => $name, 'slug' => strtolower(url_title($name, '-')), 'category_id' => strtoupper(url_title($category, '-')), 'created_at' => Time::now(), 'updated_at' => Time::now()];
